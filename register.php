...
<body>
            ...
            <div class="col-sm-8 col-md-6 col-xl-4 offset-sm-2 offset-md-3 offset-xl-4">
                ...
                <form id="formRegister">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Gelive hier je wachtwoord opnieuw in te vullen voor verificatie.</small>
                    </div>
                    <button class="btn btn-outline-primary btn-block" type="submit">Registreren</button>
                    <small>Al een account? Meld je <a href="/login.php">hier</a> aan.</small>
                </form>
            </div>
        </div>
    </div>
    ...
    <script>
        $("#formRegister").submit(async function (e) {
            ...
            const fetchResult = await fetch("/includes/doRegister.php", {
                method: "POST",
                body: formData
            });
            ...
            if (fetchResult.redirected) {
                $("#alertBoxDanger").hide();
                $("#alertBoxSuccess span:last").html("U bent nu geregistreerd, omleiden...");
